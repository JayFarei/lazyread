...
from listen_read.worker import FakeNarrationWorker, WorkerEvent
...
def test_article_processor_can_acquire_url_when_source_file_is_empty(
    ...
    class Adapter:
        def acquire(self, url: str):
            from listen_read.pipeline import acquire_markdown
...
def test_article_processor_does_not_publish_unvalidated_worker_output(
    ...
    from listen_read.pipeline import ArticleProcessingError
    import pytest
